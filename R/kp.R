...
#' 
#' kp(data = df,model = 1, save.xls = FALSE) #5PL Model adopted
#' kp(data = df,model = 2, save.xls = FALSE) #Gompertz Model adopted
#' kp(data = df,model = 3, save.xls = FALSE) #4PL Model adopted
#' 
...
#'    save.xls = TRUE,
#'    dir.save = tempdir(),
#'    xls.name = "Parameters 5PL Model.xlsx")}
#'    
#' \dontrun{kp(data = df,
#'    model = 2, #Gompertz Model
#'    save.xls = TRUE,
#'    dir.save = tempdir(),
#'    xls.name = "Parameters Gompertz Model.xlsx")}
#'
#' \dontrun{kp(data = df,
#'    model = 3, #4PL Model
#'    save.xls = TRUE,
#'    dir.save = tempdir(),
#'    xls.name = "Parameters 4PL Model.xlsx")}   
#' 
#' @import minpack.lm
#' @import openxlsx
#' 
